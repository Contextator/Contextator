 ...
 * `0018_user_mcp_credentials_epoch` ([ADR-0090](../../.ssot/ADR.md#adr-0090), FR-616) is one
 * `integer NOT NULL DEFAULT 0` column on `users` with no constraint: how many times the account's MCP
